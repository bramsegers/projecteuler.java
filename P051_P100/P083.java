 ...
 * by moving left, right, up, and down, is indicated between [] and is equal to 2297.
 * 
 *      [131]    673    [234]   [103]   [018]
 *      [201]   [096]   [342]    965    [150]
 *       630     803     746    [422]   [111]
 ...
 *       805     732     524    [037]   [331]
 *
 * Find the minimal path sum in P082.txt from the top left to the bottom right 
...
//            {805, 732, 524, 37, 331}};
    ...
    public static void main(String[] args) {
        List<String> list = Util.readText("files/P083.txt");
        ...
        System.out.println(P083.solve(arr));
    }
}
